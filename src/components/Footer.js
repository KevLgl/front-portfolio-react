...
const Footer = () => {
    return (
        ...
        <footer class="bg-primary dark:bg-gray-800 w-full py-8">
            <div class="max-w-screen-xl mx-auto px-4">
                <ul class="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
                    <li class="my-2">
                        <a class="text-gray-400 hover:text-secondary dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                            FAQ
                </a>
                    </li>
                    <li class="my-2">
                ...
                <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">         <a target="_blank" href="https://www.facebook.com/EVDRLHB" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                ...
                <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
                    <form class="flex w-full max-w-sm space-x-3">
                        ...
                        <button class="flex-shrink-0 px-4 py-2 text-base font-semibold text-secondary bg-white rounded-lg shadow-md hover:bg-secondary hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200" type="submit">
                            S'inscrire
                    </button>
                    </form>
                </div>
